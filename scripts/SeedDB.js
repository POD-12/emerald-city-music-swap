...
seeder.connect("mongodb://localhost/hipsterapp", function () {
  seeder.loadModels([
    "../models/User.js",
    "../models/Record.js"
  ]);

  seeder.clearModels(["User", "Record"], function () {
  ...
  },
  {
    ...
    "documents": [
      ...
      },
      {
        ...
        "recordComments": "An exemplary Third Stream jazz interpreation of Concierto de Aranjuez.",
        "recordPosterContact": "gilevans@hotmail.com"
      },
      {
        "recordDatePosted": new Date(Date.now()),
        ...
        "recordComments": "This is the one-song/single release. The condition isn't great, but it plays with minimal issues.",
