    ...
    <MDBContainer className="shadow-box-example rounded z-depth-1-half mt-5">
        ...
        <MDBCol md="6 p-5">
            <form>
                ...
                <MDBIcon fab icon='linkedin-in' size='md' className='grey-text'></MDBIcon>
                  </a>
                  <a href='#!' className='fa-lg p-.5 m-2 tw-ic'>
                <MDBIcon fab icon='google-plus-g' size='md' className='grey-text'></MDBIcon>
                  </a>
                  <a href='#!' className='fa-lg p-1 m-.5 tw-ic'>
                <MDBIcon fab icon='github' size='md' className='grey-text'></MDBIcon>
                  </a>
                </div>
